...
The site's live pricing page is at [`site/index.html`](site/index.html).
...
| File | Description |
|---|---|
| [`site/index.html`](site/index.html) | The public-facing site, including the pricing page |
...
| Starter | $299 | $99/mo | Website + 1 game capture session/mo + 1 highlight clip/mo |
| Growth | $399 | $199/mo | Website (custom domain) + 2 capture sessions/mo + monthly clips + quarterly full highlight reel |
| All-Access | $499 | $349/mo | Website (custom domain) + up to 4 capture sessions/mo + a full highlight reel every month + priority turnaround |
